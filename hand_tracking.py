...
def main_hand_tracking(pipe_conn=None): #pipe for data streaming
    ...
    while True:
        ...
        #giving image resized...
        #debug_image = cv.resize(image, (image.shape[1] // 2, image.shape[0] // 2), interpolation=cv.INTER_NEAREST)
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                #print(landmark_list)
                #landmark_list = list(map(lambda x: (x[0]*2, x[1]*2), landmark_list))
                #print(landmark_list)
