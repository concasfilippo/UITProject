...
def main(linea1, linea2, linea3, linea4):
    ...
    plt.plot(x1, y1, label='Linea 1 (player_intersection)', marker='o', linestyle='-', color='blue')
    plt.plot(x2, y2, label='Linea 2 (checkpoint_intersection)', marker='o', linestyle='--', color='green')
